import { GroupDto, GroupListingDto, GroupMemberDto, GroupMemberListDto, MemberListingDto } from "../../dtos/GroupDto";
import Response from "../../dtos/Response";

export default interface IGroupService {
  getAllGroup(): Promise<Response<GroupListingDto[]>>;
  getAllGroupMember(): Promise<Response<MemberListingDto[]>>;
